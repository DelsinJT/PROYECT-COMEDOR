...
if ($_POST) {
	...
	$date = date('Y-m-d');
	$sql = "SELECT * FROM product WHERE added_date>= '$startDate' AND added_date  <= '$endDate' and product_id <'" . $date . "' AND status = 1" ;
	//echo $sql;exit;
...
?>
	<div class="page-wrapper">
					...
					while ($result = $query->fetch_assoc()) { ?>
						...
						<tbody>
							<tr>
								...
								<td>
									<center><?php echo $result['product_id']; ?></center>
								</td>
		...
		<tr>
			<td colspan="3"><center>Total De Cantidad</center></td>
