...
<div class="page-wrapper">
  ...
  <div class="row page-titles">
    <div class="col-md-5 align-self-center">
      <h3 class="text-primary">Editar Boleta</h3>
    </div>
    <div class="col-md-7 align-self-center">
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="javascript:void(0)">Inicio</a></li>
        <li class="breadcrumb-item active">Editar Boletas</li>
      </ol>
    </div>
  </div>
        ...
        <div class="card">
          ...
          WHERE orders.id = {$orderId}";
                ...
                <div class="form-group col-md-12">
                  ...
                  <input type="text" class="form-control" id="clientContact" name="clientContact" placeholder="Número Móvil" autocomplete="off" value="<?php echo $data[3] ?>" pattern="^[0][9-1]\d{9}$|^[9-1]\d{9}$" />
                </div>
                ...
                <thead>
                    <tr>
                      <th style="width:40%;">Platos</th>
                      <th style="width:20%;">Precio Por Unidad</th>
                ...
                <div class="form-group col-md-6">
                  <label for="grandTotal" class="control-label">Total Descuento</label>
        ...
        if (divRequest == 'add') {
          ...
          $("#editOrderForm").unbind('submit').bind('submit', function() {
            ...
            for (var x = 0; x < quantity.length; x++) {
              var quantityId = quantity[x].id;
              if (quantity[x].value == '') {
                $("#" + quantityId + "").after('<p class="text-danger"> El campo Platos es obligatorio!! </p>');
                $("#" + quantityId + "").closest('.form-group').addClass('has-error');
              } else {
                $("#" + quantityId + "").closest('.form-group').addClass('has-success');
              }
        ...
        if (orderId) {
          ...
          $.ajax({
            ...
            success: function(response) {
              ...
              mywindow.document.write('<html><head><title>Boleta</title>');
