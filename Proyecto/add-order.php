...
<div class="page-wrapper">
  ...
  <div class="row page-titles">
    <div class="col-md-5 align-self-center">
      <h3 class="text-primary">Agregar Boleta</h3>
    </div>
    <div class="col-md-7 align-self-center">
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="javascript:void(0)">Inicio</a></li>
        <li class="breadcrumb-item active">Agregar Boleta</li>
      </ol>
    </div>
  </div>
  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-lg-11" style="    margin-left: 5%;">
              ...
              <form class="form-horizontal" method="POST" id="createOrderForm" action="php_action/order.php" action="php_action/order.php">
                ...
                <div class="form-group">
                  <div class="row">
                    ...
                    <label class="col-sm-2 control-label">No Boleta</label>
                    <div class="col-sm-4">
                      <?php
                    ...
                    <label class="col-sm-2 control-label">Fecha Boleta</label>
                ...
                <div class="form-group">
                  <div class="row">
                    ...
                    <div class="col-sm-4">
                      <input type="text" class="form-control" id="clientContact" name="clientContact" placeholder="Número de Contacto" autocomplete="off" pattern="^[0][9-1]\d{9}$|^[9-1]\d{9}$" required />
                    </div>
        ...
        <div class="form-group">
          <div class="row">
            <label for="vat" class="col-sm-2 control-label gst">IVA</label>
             <div class="col-sm-4">
