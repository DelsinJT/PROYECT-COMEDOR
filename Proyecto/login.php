...
<meta name="tamaño" content="width=device-width">
<style>
  .footer1 {
    position: fixed;
    bottom: 0;
...
<div id="main-wrapper">
  <div class="unix-login">
    ...
    <div class="container-fluid" style=" background-image: url('assets/uploadImage/Logo/colegio.png');
 background-color: #ffffff;background-size:cover  " > 
      <div class="row ">
        <div class="col-md-4">
          <div class="login-content ">
            <div class="login-form">
              <center><img src="./assets/uploadImage/Logo/logo01.jpg" style="width: 150px;"></center><br>
