...
?>
				...
				<tr class="top">
					<td colspan="6">
						<table>
							<tr>
								<td class="title">
									<img src="./assets/uploadImage/Logo/boleta.jpg" style="width: 100%; max-width: 300px" />
								</td>

								<td>
									<h1 style="margin:0 0 11px;">Boleta</h1> #:<?php echo $row['uno'] ?><br />
					...
					<td colspan="3">
						...
						<table>
							<tr><?php
								...
								<td  >
									<p style="margin: 0;" >Nombre:  Contacto:</p>
									<br /> <br>
 ...
 -->
				<tr class="total">
					...
					?>
					<td>Monto:<b><?php echo $result . "Compra  " . $points; ?></b></td>
